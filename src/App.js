      ...
      <div ref="top" className="App">
        <header className="App-header" style={{backgroundColor: colors.black}}>
          <div ref="top">
            ...
            <Navigation bootstrapBreakpoint={this.state.bootstrapBreakpoint} top={this.refs.top} bio={this.refs.bio} whatIDo={this.refs.whatIDo} skills={this.refs.skills} workHistory={this.refs.workHistory} education={this.refs.education} hobbies={this.refs.hobbies} contact={this.refs.contact} sticky={this.state.stickyHeader} navOpacity={this.state.navOpacity}/>
          </div>
        </header>
